...
<div class="login-container">
	<div class="login-card shadow text-center text-danger">
		...
		<% 
String debugError = (String) session.getAttribute("debugError");
if (debugError != null) {
    session.removeAttribute("debugError");
%>
    <div class="alert alert-danger text-start mt-3" style="white-space: pre-wrap; font-size: 12px;">
